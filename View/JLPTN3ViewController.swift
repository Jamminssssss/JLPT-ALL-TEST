...
class JLPTN3ViewController: UIViewController {
    ...
    private let level: String = "N3"
    private let quizGroup: String = "Group5" // 각 뷰에 대해 고유한 quizGroup 설정
    ...
    private func loadQuestions() {
        questions = JLPTDataLoader2.JLPTN3loadLocalData()
    }
