...
class JLPTN4ViewController: UIViewController {
    ...
    private let level: String = "N4"
    private let quizGroup: String = "Group7" // 각 뷰에 대해 고유한 quizGroup 설정
