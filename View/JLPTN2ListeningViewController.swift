//
//  JLPTN2ListeningViewController.swift
//  JLPT ALL TEST
//
...
class JLPTN2ListeningViewController: UIViewController {
    ...
    private let level: String = "N2Audio"
    private let quizGroup: String = "Group4"  // 예시로 그룹을 "Group1"으로 설정
