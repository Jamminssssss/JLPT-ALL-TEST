//
//  JLPTN5ListeningViewController.swift
//  JLPT ALL TEST
//
...
class JLPTN5ListeningViewController: UIViewController {
    ...
    private let level: String = "N5Audio"
    private let quizGroup: String = "Group10"  // 예시로 그룹을 "Group1"으로 설정
